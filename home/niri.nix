...
in
{
  xdg.configFile = {
    "niri/config.kdl".text = ''
      ...
      // Monitor layout generated by nwg-displays (mutable, not managed by home-manager)
      ...
      // Make sure that wezterm fills the vertical monitor
      window-rule {
          match app-id="org.wezfurlong.wezterm"
          default-column-width { fixed 1192; }
      }
